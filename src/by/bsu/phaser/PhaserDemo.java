...
public class PhaserDemo {
    public static void main(String[] args) {
        ...
        printGoodsToConsole("Product on sclad A", storageA);
        printGoodsToConsole("Product on sclad B", storageB);
        tr1.start();
        tr2.start();
        tr3.start();
        // Synch load
        ...
        System.out.println("Load colonn complite. Phase " + currentPhase + " complite.");
        // Synch drive
        currentPhase = phaser.getPhase();
        phaser.arriveAndAwaitAdvance();
        System.out.println("Drive colonn complite. Phase " + currentPhase + " complite.");
        // Synch unload
        currentPhase = phaser.getPhase();
        phaser.arriveAndAwaitAdvance();
        System.out.println("Unload colonn complite. Phase " + currentPhase + " complite");
